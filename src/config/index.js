    ...
    this.defaults = {
      ...
      detection: {
        ...
        rtspParity: {
          ...
          parityLogPath: process.env.RTSP_PARITY_LOG_PATH || null,
          ...
          smartfaceLmkParam: process.env.RTSP_PARITY_SMARTFACE_LMK_PARAM || null,
          smartfaceLmkBin: process.env.RTSP_PARITY_SMARTFACE_LMK_BIN || null,
          smartfaceExtractParam: process.env.RTSP_PARITY_SMARTFACE_EXTRACT_PARAM || null,
          smartfaceExtractBin: process.env.RTSP_PARITY_SMARTFACE_EXTRACT_BIN || null,
          ...
          smartfaceIdentityDistanceThreshold: envFloat('RTSP_PARITY_SMARTFACE_IDENTITY_DISTANCE_THRESHOLD', 0.35),
          smartfaceIdentityStableFrames: envInt('RTSP_PARITY_SMARTFACE_IDENTITY_STABLE_FRAMES', 2),
          smartfaceIdentityMinFaceScore: envFloat('RTSP_PARITY_SMARTFACE_IDENTITY_MIN_FACE_SCORE', 0.75),
          smartfaceIdentityMinFaceAreaRatio: envFloat('RTSP_PARITY_SMARTFACE_IDENTITY_MIN_FACE_AREA_RATIO', 0.0012),
          smartfaceIdentityRequireLandmarks: process.env.RTSP_PARITY_SMARTFACE_IDENTITY_REQUIRE_LANDMARKS === 'true',
          smartfaceIdentitySplitGuardRatio: envFloat('RTSP_PARITY_SMARTFACE_IDENTITY_SPLIT_GUARD_RATIO', 0.9),
          smartfaceIdentitySplitGuardMaxSeen: envInt('RTSP_PARITY_SMARTFACE_IDENTITY_SPLIT_GUARD_MAX_SEEN', 3),
          ...
          identityGalleryMaxIdleMs: envInt('RTSP_PARITY_IDENTITY_GALLERY_MAX_IDLE_MS', 2592000000),
          identityGalleryPruneIntervalFrames: envInt('RTSP_PARITY_IDENTITY_GALLERY_PRUNE_INTERVAL_FRAMES', 30),
    ...
    return {
      ...
      detection: {
        ...
        rtspParity: {
          ...
          smartfaceParam: null,
          smartfaceBin: null,
          smartfaceLmkParam: null,
          smartfaceLmkBin: null,
          smartfaceExtractParam: null,
          smartfaceExtractBin: null,
          smartfaceInputSize: 112,
          smartfaceMinScore: 0.75,
          smartfaceStableFrames: 2,
          smartfaceIdentityDistanceThreshold: 0.35,
          smartfaceIdentityStableFrames: 2,
          smartfaceIdentityMinFaceScore: 0.75,
          smartfaceIdentityMinFaceAreaRatio: 0.0012,
          smartfaceIdentityRequireLandmarks: false,
          smartfaceIdentitySplitGuardRatio: 0.9,
          smartfaceIdentitySplitGuardMaxSeen: 3,
          ...
          identityGalleryMaxIdleMs: 2592000000,
          identityGalleryPruneIntervalFrames: 30,
          maxFrames: 0,
